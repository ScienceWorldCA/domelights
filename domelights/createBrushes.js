...
function CreateBrushes() 
{
	var config = true;
	/*
	Create_WipeBrush(config);
	Create_ColorBrush(config);
	Create_GradientBackgroundBrush(config);
	Create_VerticalRainbowWipeBrush(config);
	Create_DomeFlashBrush(config);
	Create_HorizontalRingBrush(config);
	Create_VerticalRingBrush(config);
	Create_LaunchBrush(config);
	Create_FireWorkBurstBrush(config);
	Create_FireWorkBrush(config);
	
	Create_SequenceTwoColorCycle(config);
...
function Create_WipeBrush(options)				// INDEX: 0
{
	console.log(options);
...
function Create_ColorBrush(options)				// INDEX: 1
{
	...
	Brushes[ColorBrush.Index] = ColorBrush;
}

function Create_GradientBackgroundBrush(options)	// INDEX: 2
{
	...
	Brushes[GradientBackgroundBrush.Index] = GradientBackgroundBrush;
}

function Create_VerticalRainbowWipeBrush(options)// INDEX: 3
{
	...
	Brushes[VerticalRainbowWipeBrush.Index] = VerticalRainbowWipeBrush;
}

function Create_DomeFlashBrush(options)			// INDEX: 4
{
...
function Create_HorizontalRingBrush(options)		// INDEX: 5
{
...
function Create_VerticalRingBrush(options)		// INDEX: 6
{
...
function Create_FireWorkBurstBrush(options)		// INDEX: 8
{
	...
	Brushes[FireWorkBurstBrush.Index] = FireWorkBurstBrush;
}

function Create_FireWorkBrush(options)			// INDEX: 9
{
...
function Create_SequenceTwoColorCycle(options)	// INDEX: 10
{
...
function Create_SolidColorBrush(options)			// INDEX: 11
{
	...
	Brushes[SolidColorBrush.Index] = SolidColorBrush;
}

function Create_FireBackground(options)			// INDEX: 12
{
...
function Create_PatternBrush(options)			// INDEX: 13
{
	var PatternBrush = new Brush();
