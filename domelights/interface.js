...
function buildInterface() {
    ...
    {
        var button1 = new UIObjectManager.CreateButton('textures/sprites/circle.png', new THREE.Vector2(190, 50), new THREE.Vector2(20, 20));
        button1.onMouseDown = ButtonDownClick;
        button1.onMouseUp = SetBrush;
        button1.material.color.setRGB(0, 1, 0);
        button1.index = 1;

        var button2 = new UIObjectManager.CreateButton('textures/sprites/circle.png', new THREE.Vector2(190, 70), new THREE.Vector2(20, 20));
        button2.onMouseUp = SetBrush;
        button2.onMouseDown = ButtonDownClick;
        button2.material.color.setRGB(1, 0, 0);
        button2.index = 1;

        var button3 = new UIObjectManager.CreateButton('textures/sprites/circle.png', new THREE.Vector2(190, 90), new THREE.Vector2(20, 20));
        button3.onMouseUp = SetBrush;
        button3.onMouseDown = ButtonDownClick;
        button3.material.color.setRGB(0, 0, 1);
        button3.index = 1;

        var button4 = new UIObjectManager.CreateButton('textures/sprites/circle.png', new THREE.Vector2(170, 50), new THREE.Vector2(20, 20));
        button4.onMouseDown = ButtonDownClick;
        button4.onMouseUp = SetBrush;
        button4.material.color.setRGB(1, 1, 0);
        button4.index = 1;

        var button5 = new UIObjectManager.CreateButton('textures/sprites/circle.png', new THREE.Vector2(170, 70), new THREE.Vector2(20, 20));
        button5.onMouseUp = SetBrush;
        button5.onMouseDown = ButtonDownClick;
        button5.material.color.setRGB(1, 0, 1);
        button5.index = 1;

        var button6 = new UIObjectManager.CreateButton('textures/sprites/circle.png', new THREE.Vector2(170, 90), new THREE.Vector2(20, 20));
